...
const HeritageNarrative = () => {
  ...
  return (
    <section ref={ref} className="relative bg-charcoal text-white overflow-hidden">
      <div className="relative h-[70vh] z-0">
        <motion.div 
      ...
      <div className="relative z-10 bg-charcoal">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 px-6 md:px-12 py-24">
          {[{
            ...
            <motion.div key={col.title} custom={i} variants={columnVariant} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
              <h3 className="text-2xl font-serif text-warm-copper mb-4 border-b border-warm-copper/20 pb-2">{col.title}</h3>
